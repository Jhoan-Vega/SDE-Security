...
<div class="container-fluid">
    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="ambientes.php">
              <span data-feather="home"></span>
              Control Accesos <span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
  ...
  <div class="card-body">
  <h5 class="card-title">Control Accesos | <small>SDE Security</small></h5>
  <p>
        ...
        <table class="table table-striped table-sm">
          <thead>
            ...
            <th scope="col">Usuario</th>
                ...
                <th scope="col">Hora y Fecha de acceso</th>
