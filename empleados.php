...
<div class="container-fluid">
  ...
  <div class="card-body">
  <h5 class="card-title">Empleados | <small>SDE Security</small></h5>
  <p>
        ...
        <table class="table table-striped table-sm">
          ...
          <?php
            ...
            <tr>
                ...
                <td><?php echo $row['telf_empl'];?></td>
                <td><?php echo $row['dir_empl'];?></td>
                <td><?php echo $row['ciudad_empl'];?></td>
                <td><?php echo $row['dni_empl'];?></td>
              </tr>
          </tbody>
          <?php } ?>
        </table>
